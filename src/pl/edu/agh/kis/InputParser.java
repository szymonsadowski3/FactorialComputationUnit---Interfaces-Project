...
/**
 * The Class InputParser, which is used to get and parse User inputs
 * 
...
public class InputParser {
	 ...
	 * Message displayed before acquiring User's input
	 * @return
	 * Acquired String typed in by User
	 */
	 ...
	 * @return
	 * Pair object, which contains two integers typed my user
	 */
	public static Pair getPair(String message) {
		...
		try {
            ...
            //This Pair is valued like that, because it will break the loop in runWithPrioritization() function
        }
